...
func (g *Gun) case1_method(client pb.BlocksApiClient, ammo *Ammo) int {
	...
	out, err := client.GetBlock(context.Background(), &pb.BlockRequest{
		IncludeTransactions: false, Request: &pb.BlockRequest_Height{Height: int32(height)}})
...
func main() {
	...
	register.Gun("blocks_headers_gun", NewGun, func() GunConfig {
		return GunConfig{
